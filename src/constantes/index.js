...
const ASIGNATURA_TECNICO_ELECTR_OPTIONS = [
    '-',
    'PLC',
    'CONTROLES',
    'HIDRAULICA'
...
const ASIGNATURA_TECNICO_INF_OPTIONS = [
    '-',
    'BASE DE DATOS',
...
const ASIGNATURA_TECNICO_CONTA_OPTIONS = [
    '-',
    'CONTABILIDAD'
];

const ASIGNATURA_TECNICO_TURIS_OPTIONS = [
    '-',
    'TURISMO',
];

const ASIGNATURA_TECNICO_MER_OPTIONS = [
    '-',
    'MERCADEO'
];
...
const PROFESOR_GENERAL_OPTIONS = [
    '-',
    'Juan General',
    '',
    '',
...
const PROFESOR_TECNICO_ELECTR_OPTIONS = [
    '-',
    'Migel Electrico',
    '',
    '',
...
const PROFESOR_TECNICO_CONTA_OPTIONS = [
    '-',
    'Pedro Contabilidad',
    '',
    '',
...
const PROFESOR_TECNICO_TURIS_OPTIONS = [
    '-',
    'Juana Turismo',
    '',
    '',
...
const PROFESOR_TECNICO_MER_OPTIONS = [
    '-',
    'Maria Mercadeo',
    '',
    '',
...
const PROFESOR_TECNICO_INF_OPTIONS = [
    '-',
    'Maria Mercadeo',
    '',
    '',
...
const CENTRO_EDUCATIVO_OPTIONS = [
    '-',
    'CEMAS',
    '',
    '',
